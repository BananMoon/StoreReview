    ...
    public String createTokenFromAuthentication(Authentication authentication) throws Exception
    {
        ...
        try {
            jwt = Jwts.builder()
                    ...
                    .claim("suid", cryptUtils.AES_Encode(((JWTUserDetails) authentication.getPrincipal()).getSuid()))
                    .claim("said", cryptUtils.AES_Encode(((JWTUserDetails) authentication.getPrincipal()).getSaid()))
